...
`)}const $p={[il]:"Linear",[rl]:"Reinhard",[sl]:"Cineon",[al]:"ACESFilmic",[ll]:"AgX",[cl]:"Neutral",[ol]:"Custom"};function Kp(i,t){const e=$p[t];return e===void 0?(Rt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const pr=new D;function jp(){Vt.getLuminanceCoefficients(pr);const i=pr.x.toFixed(4),t=pr.y.toFixed(4),e=pr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`].filter(bi).join(`
`)),a=Sa(a),a=Zo(a,e),a=Jo(a,e),o=Sa(o),o=Zo(o,e),o=Jo(o,e),a=$o(a),o=$o(o),e.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
}`;class Gm{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e){if(this.texture===null){const n=new Rl(t.texture);(t.depthNear!==e.depthNear||t.depthFar!==e.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=n}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,n=new en({vertexShader:zm,fragmentShader:Vm,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new Xe(new Lr(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Hm extends ci{constructor(t,e){super();const n=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,h=null,u=null,d=null,p=null,_=null;const x=typeof XRWebGLBinding<"u",m=new Gm,f={},b=e.getContextAttributes();let M=null,y=null;const A=[],w=[],R=new yt;let F=null;const S=new Ue;S.viewport=new le;const E=new Ue;E.viewport=new le;const L=[S,E],G=new Kh;let V=null,Y=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(q){let K=A[q];return K===void 0&&(K=new os,A[q]=K),K.getTargetRaySpace()},this.getControllerGrip=function(q){let K=A[q];return K===void 0&&(K=new os,A[q]=K),K.getGripSpace()},this.getHand=function(q){let K=A[q];return K===void 0&&(K=new os,A[q]=K),K.getHandSpace()};function X(q){const K=w.indexOf(q.inputSource);if(K===-1)return;const pt=A[K];pt!==void 0&&(pt.update(q.inputSource,q.frame,c||a),pt.dispatchEvent({type:q.type,data:q.inputSource}))}function k(){r.removeEventListener("select",X),r.removeEventListener("selectstart",X),r.removeEventListener("selectend",X),r.removeEventListener("squeeze",X),r.removeEventListener("squeezestart",X),r.removeEventListener("squeezeend",X),r.removeEventListener("end",k),r.removeEventListener("inputsourceschange",z);for(let q=0;q<A.length;q++){const K=w[q];K!==null&&(w[q]=null,A[q].disconnect(K))}V=null,Y=null,m.reset();for(const q in f)delete f[q];t.setRenderTarget(M),p=null,d=null,u=null,r=null,y=null,ne.stop(),n.isPresenting=!1,t.setPixelRatio(F),t.setSize(R.width,R.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(q){s=q,n.isPresenting===!0&&Rt("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(q){o=q,n.isPresenting===!0&&Rt("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(q){c=q},this.getBaseLayer=function(){return d!==null?d:p},this.getBinding=function(){return u===null&&x&&(u=new XRWebGLBinding(r,e)),u},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(q){if(r=q,r!==null){if(M=t.getRenderTarget(),r.addEventListener("select",X),r.addEventListener("selectstart",X),r.addEventListener("selectend",X),r.addEventListener("squeeze",X),r.addEventListener("squeezestart",X),r.addEventListener("squeezeend",X),r.addEventListener("end",k),r.addEventListener("inputsourceschange",z),b.xrCompatible!==!0&&await e.makeXRCompatible(),F=t.getPixelRatio(),t.getSize(R),x&&"createProjectionLayer"in XRWebGLBinding.prototype){let pt=null,Pt=null,_t=null;b.depth&&(_t=b.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,pt=b.stencil?On:pn,Pt=b.stencil?Pi:tn);const Gt={colorFormat:e.RGBA8,depthFormat:_t,scaleFactor:s};u=this.getBinding(),d=u.createProjectionLayer(Gt),r.updateRenderState({layers:[d]}),t.setPixelRatio(1),t.setSize(d.textureWidth,d.textureHeight,!1),y=new je(d.textureWidth,d.textureHeight,{format:We,type:Ne,depthTexture:new Li(d.textureWidth,d.textureHeight,Pt,void 0,void 0,void 0,void 0,void 0,void 0,pt),stencilBuffer:b.stencil,colorSpace:t.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{const pt={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,e,pt),r.updateRenderState({baseLayer:p}),t.setPixelRatio(1),t.setSize(p.framebufferWidth,p.framebufferHeight,!1),y=new je(p.framebufferWidth,p.framebufferHeight,{format:We,type:Ne,colorSpace:t.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),ne.setContext(r),ne.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function z(q){for(let K=0;K<q.removed.length;K++){const pt=q.removed[K],Pt=w.indexOf(pt);Pt>=0&&(w[Pt]=null,A[Pt].disconnect(pt))}for(let K=0;K<q.added.length;K++){const pt=q.added[K];let Pt=w.indexOf(pt);if(Pt===-1){for(let Gt=0;Gt<A.length;Gt++)if(Gt>=w.length){w.push(pt),Pt=Gt;break}else if(w[Gt]===null){w[Gt]=pt,Pt=Gt;break}if(Pt===-1)break}const _t=A[Pt];_t&&_t.connect(pt)}}const $=new D,ht=new D;function at(q,K,pt){$.setFromMatrixPosition(K.matrixWorld),ht.setFromMatrixPosition(pt.matrixWorld);const Pt=$.distanceTo(ht),_t=K.projectionMatrix.elements,Gt=pt.projectionMatrix.elements,me=_t[14]/(_t[10]-1),zt=_t[14]/(_t[10]+1),qt=(_t[9]+1)/_t[5],Kt=(_t[9]-1)/_t[5],Ut=(_t[8]-1)/_t[0],ce=(Gt[8]+1)/Gt[0],C=me*Ut,he=me*ce,Xt=Pt/(-Ut+ce),Qt=Xt*-Ut;if(K.matrixWorld.decompose(q.position,q.quaternion,q.scale),q.translateX(Qt),q.translateZ(Xt),q.matrixWorld.compose(q.position,q.quaternion,q.scale),q.matrixWorldInverse.copy(q.matrixWorld).invert(),_t[10]===-1)q.projectionMatrix.copy(K.projectionMatrix),q.projectionMatrixInverse.copy(K.projectionMatrixInverse);else{const vt=me+Xt,T=zt+Xt,g=C-Qt,I=he+(Pt-Qt),W=qt*zt/T*vt,J=Kt*zt/T*vt;q.projectionMatrix.makePerspective(g,I,W,J,vt,T),q.projectionMatrixInverse.copy(q.projectionMatrix).invert()}}function ut(q,K){K===null?q.matrixWorld.copy(q.matrix):q.matrixWorld.multiplyMatrices(K.matrixWorld,q.matrix),q.matrixWorldInverse.copy(q.matrixWorld).invert()}this.updateCamera=function(q){if(r===null)return;let K=q.near,pt=q.far;m.texture!==null&&(m.depthNear>0&&(K=m.depthNear),m.depthFar>0&&(pt=m.depthFar)),G.near=E.near=S.near=K,G.far=E.far=S.far=pt,(V!==G.near||Y!==G.far)&&(r.updateRenderState({depthNear:G.near,depthFar:G.far}),V=G.near,Y=G.far),G.layers.mask=q.layers.mask|6,S.layers.mask=G.layers.mask&3,E.layers.mask=G.layers.mask&5;const Pt=q.parent,_t=G.cameras;ut(G,Pt);for(let Gt=0;Gt<_t.length;Gt++)ut(_t[Gt],Pt);_t.length===2?at(G,S,E):G.projectionMatrix.copy(S.projectionMatrix),Ft(q,G,Pt)};function Ft(q,K,pt){pt===null?q.matrix.copy(K.matrixWorld):(q.matrix.copy(pt.matrixWorld),q.matrix.invert(),q.matrix.multiply(K.matrixWorld)),q.matrix.decompose(q.position,q.quaternion,q.scale),q.updateMatrixWorld(!0),q.projectionMatrix.copy(K.projectionMatrix),q.projectionMatrixInverse.copy(K.projectionMatrixInverse),q.isPerspectiveCamera&&(q.fov=ua*2*Math.atan(1/q.projectionMatrix.elements[5]),q.zoom=1)}this.getCamera=function(){return G},this.getFoveation=function(){if(!(d===null&&p===null))return l},this.setFoveation=function(q){l=q,d!==null&&(d.fixedFoveation=q),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=q)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(G)},this.getCameraTexture=function(q){return f[q]};let It=null;function re(q,K){if(h=K.getViewerPose(c||a),_=K,h!==null){const pt=h.views;p!==null&&(t.setRenderTargetFramebuffer(y,p.framebuffer),t.setRenderTarget(y));let Pt=!1;pt.length!==G.cameras.length&&(G.cameras.length=0,Pt=!0);for(let zt=0;zt<pt.length;zt++){const qt=pt[zt];let Kt=null;if(p!==null)Kt=p.getViewport(qt);else{const ce=u.getViewSubImage(d,qt);Kt=ce.viewport,zt===0&&(t.setRenderTargetTextures(y,ce.colorTexture,ce.depthStencilTexture),t.setRenderTarget(y))}let Ut=L[zt];Ut===void 0&&(Ut=new Ue,Ut.layers.enable(zt),Ut.viewport=new le,L[zt]=Ut),Ut.matrix.fromArray(qt.transform.matrix),Ut.matrix.decompose(Ut.position,Ut.quaternion,Ut.scale),Ut.projectionMatrix.fromArray(qt.projectionMatrix),Ut.projectionMatrixInverse.copy(Ut.projectionMatrix).invert(),Ut.viewport.set(Kt.x,Kt.y,Kt.width,Kt.height),zt===0&&(G.matrix.copy(Ut.matrix),G.matrix.decompose(G.position,G.quaternion,G.scale)),Pt===!0&&G.cameras.push(Ut)}const _t=r.enabledFeatures;if(_t&&_t.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&x){u=n.getBinding();const zt=u.getDepthInformation(pt[0]);zt&&zt.isValid&&zt.texture&&m.init(zt,r.renderState)}if(_t&&_t.includes("camera-access")&&x){t.state.unbindTexture(),u=n.getBinding();for(let zt=0;zt<pt.length;zt++){const qt=pt[zt].camera;if(qt){let Kt=f[qt];Kt||(Kt=new Rl,f[qt]=Kt);const Ut=u.getCameraImage(qt);Kt.sourceTexture=Ut}}}}for(let pt=0;pt<A.length;pt++){const Pt=w[pt],_t=A[pt];Pt!==null&&_t!==void 0&&_t.update(Pt,K,c||a)}It&&It(q,K),K.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:K}),_=null}const ne=new Vl;ne.setAnimationLoop(re),this.setAnimationLoop=function(q){It=q},this.dispose=function(){}}}const Ln=new mn,km=new ie;function Wm(i,t){function e(m,f){m.matrixAutoUpdate===!0&&m.updateMatrix(),f.value.copy(m.matrix)}function n(m,f){f.color.getRGB(m.fogColor.value,Tl(i)),f.isFog?(m.fogNear.value=f.near,m.fogFar.value=f.far):f.isFogExp2&&(m.fogDensity.value=f.density)}function r(m,f,b,M,y){f.isMeshBasicMaterial||f.isMeshLambertMaterial?s(m,f):f.isMeshToonMaterial?(s(m,f),u(m,f)):f.isMeshPhongMaterial?(s(m,f),h(m,f)):f.isMeshStandardMaterial?(s(m,f),d(m,f),f.isMeshPhysicalMaterial&&p(m,f,y)):f.isMeshMatcapMaterial?(s(m,f),_(m,f)):f.isMeshDepthMaterial?s(m,f):f.isMeshDistanceMaterial?(s(m,f),x(m,f)):f.isMeshNormalMaterial?s(m,f):f.isLineBasicMaterial?(a(m,f),f.isLineDashedMaterial&&o(m,f)):f.isPointsMaterial?l(m,f,b,M):f.isSpriteMaterial?c(m,f):f.isShadowMaterial?(m.color.value.copy(f.color),m.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function s(m,f){m.opacity.value=f.opacity,f.color&&m.diffuse.value.copy(f.color),f.emissive&&m.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(m.map.value=f.map,e(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.bumpMap&&(m.bumpMap.value=f.bumpMap,e(f.bumpMap,m.bumpMapTransform),m.bumpScale.value=f.bumpScale,f.side===Ce&&(m.bumpScale.value*=-1)),f.normalMap&&(m.normalMap.value=f.normalMap,e(f.normalMap,m.normalMapTransform),m.normalScale.value.copy(f.normalScale),f.side===Ce&&m.normalScale.value.negate()),f.displacementMap&&(m.displacementMap.value=f.displacementMap,e(f.displacementMap,m.displacementMapTransform),m.displacementScale.value=f.displacementScale,m.displacementBias.value=f.displacementBias),f.emissiveMap&&(m.emissiveMap.value=f.emissiveMap,e(f.emissiveMap,m.emissiveMapTransform)),f.specularMap&&(m.specularMap.value=f.specularMap,e(f.specularMap,m.specularMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest);const b=t.get(f),M=b.envMap,y=b.envMapRotation;M&&(m.envMap.value=M,Ln.copy(y),Ln.x*=-1,Ln.y*=-1,Ln.z*=-1,M.isCubeTexture&&M.isRenderTargetTexture===!1&&(Ln.y*=-1,Ln.z*=-1),m.envMapRotation.value.setFromMatrix4(km.makeRotationFromEuler(Ln)),m.flipEnvMap.value=M.isCubeTexture&&M.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=f.reflectivity,m.ior.value=f.ior,m.refractionRatio.value=f.refractionRatio),f.lightMap&&(m.lightMap.value=f.lightMap,m.lightMapIntensity.value=f.lightMapIntensity,e(f.lightMap,m.lightMapTransform)),f.aoMap&&(m.aoMap.value=f.aoMap,m.aoMapIntensity.value=f.aoMapIntensity,e(f.aoMap,m.aoMapTransform))}function a(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,f.map&&(m.map.value=f.map,e(f.map,m.mapTransform))}function o(m,f){m.dashSize.value=f.dashSize,m.totalSize.value=f.dashSize+f.gapSize,m.scale.value=f.scale}function l(m,f,b,M){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.size.value=f.size*b,m.scale.value=M*.5,f.map&&(m.map.value=f.map,e(f.map,m.uvTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function c(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.rotation.value=f.rotation,f.map&&(m.map.value=f.map,e(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,e(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function h(m,f){m.specular.value.copy(f.specular),m.shininess.value=Math.max(f.shininess,1e-4)}function u(m,f){f.gradientMap&&(m.gradientMap.value=f.gradientMap)}function d(m,f){m.metalness.value=f.metalness,f.metalnessMap&&(m.metalnessMap.value=f.metalnessMap,e(f.metalnessMap,m.metalnessMapTransform)),m.roughness.value=f.roughness,f.roughnessMap&&(m.roughnessMap.value=f.roughnessMap,e(f.roughnessMap,m.roughnessMapTransform)),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)}function p(m,f,b){m.ior.value=f.ior,f.sheen>0&&(m.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),m.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(m.sheenColorMap.value=f.sheenColorMap,e(f.sheenColorMap,m.sheenColorMapTransform)),f.sheenRoughnessMap&&(m.sheenRoughnessMap.value=f.sheenRoughnessMap,e(f.sheenRoughnessMap,m.sheenRoughnessMapTransform))),f.clearcoat>0&&(m.clearcoat.value=f.clearcoat,m.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(m.clearcoatMap.value=f.clearcoatMap,e(f.clearcoatMap,m.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,e(f.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(m.clearcoatNormalMap.value=f.clearcoatNormalMap,e(f.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===Ce&&m.clearcoatNormalScale.value.negate())),f.dispersion>0&&(m.dispersion.value=f.dispersion),f.iridescence>0&&(m.iridescence.value=f.iridescence,m.iridescenceIOR.value=f.iridescenceIOR,m.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(m.iridescenceMap.value=f.iridescenceMap,e(f.iridescenceMap,m.iridescenceMapTransform)),f.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=f.iridescenceThicknessMap,e(f.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),f.transmission>0&&(m.transmission.value=f.transmission,m.transmissionSamplerMap.value=b.texture,m.transmissionSamplerSize.value.set(b.width,b.height),f.transmissionMap&&(m.transmissionMap.value=f.transmissionMap,e(f.transmissionMap,m.transmissionMapTransform)),m.thickness.value=f.thickness,f.thicknessMap&&(m.thicknessMap.value=f.thicknessMap,e(f.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=f.attenuationDistance,m.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(m.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(m.anisotropyMap.value=f.anisotropyMap,e(f.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=f.specularIntensity,m.specularColor.value.copy(f.specularColor),f.specularColorMap&&(m.specularColorMap.value=f.specularColorMap,e(f.specularColorMap,m.specularColorMapTransform)),f.specularIntensityMap&&(m.specularIntensityMap.value=f.specularIntensityMap,e(f.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,f){f.matcap&&(m.matcap.value=f.matcap)}function x(m,f){const b=t.get(f).light;m.referencePosition.value.setFromMatrixPosition(b.matrixWorld),m.nearDistance.value=b.shadow.camera.near,m.farDistance.value=b.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function Xm(i,t,e,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(b,M){const y=M.program;n.uniformBlockBinding(b,y)}function c(b,M){let y=r[b.id];y===void 0&&(_(b),y=h(b),r[b.id]=y,b.addEventListener("dispose",m));const A=M.program;n.updateUBOMapping(b,A);const w=t.render.frame;s[b.id]!==w&&(d(b),s[b.id]=w)}function h(b){const M=u();b.__bindingPointIndex=M;const y=i.createBuffer(),A=b.__size,w=b.usage;return i.bindBuffer(i.UNIFORM_BUFFER,y),i.bufferData(i.UNIFORM_BUFFER,A,w),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,M,y),y}function u(){for(let b=0;b<o;b++)if(a.indexOf(b)===-1)return a.push(b),b;return kt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(b){const M=r[b.id],y=b.uniforms,A=b.__cache;i.bindBuffer(i.UNIFORM_BUFFER,M);for(let w=0,R=y.length;w<R;w++){const F=Array.isArray(y[w])?y[w]:[y[w]];for(let S=0,E=F.length;S<E;S++){const L=F[S];if(p(L,w,S,A)===!0){const G=L.__offset,V=Array.isArray(L.value)?L.value:[L.value];let Y=0;for(let X=0;X<V.length;X++){const k=V[X],z=x(k);typeof k=="number"||typeof k=="boolean"?(L.__data[0]=k,i.bufferSubData(i.UNIFORM_BUFFER,G+Y,L.__data)):k.isMatrix3?(L.__data[0]=k.elements[0],L.__data[1]=k.elements[1],L.__data[2]=k.elements[2],L.__data[3]=0,L.__data[4]=k.elements[3],L.__data[5]=k.elements[4],L.__data[6]=k.elements[5],L.__data[7]=0,L.__data[8]=k.elements[6],L.__data[9]=k.elements[7],L.__data[10]=k.elements[8],L.__data[11]=0):(k.toArray(L.__data,Y),Y+=z.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,G,L.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function p(b,M,y,A){const w=b.value,R=M+"_"+y;if(A[R]===void 0)return typeof w=="number"||typeof w=="boolean"?A[R]=w:A[R]=w.clone(),!0;{const F=A[R];if(typeof w=="number"||typeof w=="boolean"){if(F!==w)return A[R]=w,!0}else if(F.equals(w)===!1)return F.copy(w),!0}return!1}function _(b){const M=b.uniforms;let y=0;const A=16;for(let R=0,F=M.length;R<F;R++){const S=Array.isArray(M[R])?M[R]:[M[R]];for(let E=0,L=S.length;E<L;E++){const G=S[E],V=Array.isArray(G.value)?G.value:[G.value];for(let Y=0,X=V.length;Y<X;Y++){const k=V[Y],z=x(k),$=y%A,ht=$%z.boundary,at=$+ht;y+=ht,at!==0&&A-at<z.storage&&(y+=A-at),G.__data=new Float32Array(z.storage/Float32Array.BYTES_PER_ELEMENT),G.__offset=y,y+=z.storage}}}const w=y%A;return w>0&&(y+=A-w),b.__size=y,b.__cache={},this}function x(b){const M={boundary:0,storage:0};return typeof b=="number"||typeof b=="boolean"?(M.boundary=4,M.storage=4):b.isVector2?(M.boundary=8,M.storage=8):b.isVector3||b.isColor?(M.boundary=16,M.storage=12):b.isVector4?(M.boundary=16,M.storage=16):b.isMatrix3?(M.boundary=48,M.storage=48):b.isMatrix4?(M.boundary=64,M.storage=64):b.isTexture?Rt("WebGLRenderer: Texture samplers can not be part of an uniforms group."):Rt("WebGLRenderer: Unsupported uniform value type.",b),M}function m(b){const M=b.target;M.removeEventListener("dispose",m);const y=a.indexOf(M.__bindingPointIndex);a.splice(y,1),i.deleteBuffer(r[M.id]),delete r[M.id],delete s[M.id]}function f(){for(const b in r)i.deleteBuffer(r[b]);a=[],r={},s={}}return{bind:l,update:c,dispose:f}}const qm=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Ye=null;function Ym(){return Ye===null&&(Ye=new lh(qm,16,16,si,dn),Ye.name="DFG_LUT",Ye.minFilter=Se,Ye.magFilter=Se,Ye.wrapS=hn,Ye.wrapT=hn,Ye.generateMipmaps=!1,Ye.needsUpdate=!0),Ye}class Zm{constructor(t={}){const{canvas:e=Nc(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1,reversedDepthBuffer:d=!1,outputBufferType:p=Ne}=t;this.isWebGLRenderer=!0;let _;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=n.getContextAttributes().alpha}else _=a;const x=p,m=new Set([wa,Aa,ba]),f=new Set([Ne,tn,Ci,Pi,Ea,Ta]),b=new Uint32Array(4),M=new Int32Array(4);let y=null,A=null;const w=[],R=[];let F=null;this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Ke,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const S=this;let E=!1;this._outputColorSpace=Be;let L=0,G=0,V=null,Y=-1,X=null;const k=new le,z=new le;let $=null;const ht=new Wt(0);let at=0,ut=e.width,Ft=e.height,It=1,re=null,ne=null;const q=new le(0,0,ut,Ft),K=new le(0,0,ut,Ft);let pt=!1;const Pt=new La;let _t=!1,Gt=!1;const me=new ie,zt=new D,qt=new le,Kt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Ut=!1;function ce(){return V===null?It:1}let C=n;function he(v,U){return e.getContext(v,U)}try{const v={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${Ma}`),e.addEventListener("webglcontextlost",Ct,!1),e.addEventListener("webglcontextrestored",te,!1),e.addEventListener("webglcontextcreationerror",Yt,!1),C===null){const U="webgl2";if(C=he(U,v),C===null)throw he(U)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(v){throw kt("WebGLRenderer: "+v.message),v}let Xt,Qt,vt,T,g,I,W,J,H,Mt,nt,xt,wt,Q,rt,gt,St,it,Nt,P,ct,tt,ft,j;function Z(){Xt=new Yd(C),Xt.init(),tt=new Bm(C,Xt),Qt=new Bd(C,Xt,t,tt),vt=new Fm(C,Xt),Qt.reversedDepthBuffer&&d&&vt.buffers.depth.setReversed(!0),T=new $d(C),g=new Mm,I=new Om(C,Xt,vt,g,Qt,tt,T),W=new Vd(S),J=new qd(S),H=new Qh(C),ft=new Fd(C,H),Mt=new Zd(C,H,T,ft),nt=new jd(C,Mt,H,T),Nt=new Kd(C,Qt,I),gt=new zd(g),xt=new Sm(S,W,J,Xt,Qt,ft,gt),wt=new Wm(S,g),Q=new Em,rt=new Cm(Xt),it=new Nd(S,W,J,vt,nt,_,l),St=new Um(S,nt,Qt),j=new Xm(C,T,Qt,vt),P=new Od(C,Xt,T),ct=new Jd(C,Xt,T),T.programs=xt.programs,S.capabilities=Qt,S.extensions=Xt,S.properties=g,S.renderLists=Q,S.shadowMap=St,S.state=vt,S.info=T}Z(),x!==Ne&&(F=new tp(x,e.width,e.height,r,s));const et=new Hm(S,C);this.xr=et,this.getContext=function(){return C},this.getContextAttributes=function(){return C.getContextAttributes()},this.forceContextLoss=function(){const v=Xt.get("WEBGL_lose_context");v&&v.loseContext()},this.forceContextRestore=function(){const v=Xt.get("WEBGL_lose_context");v&&v.restoreContext()},this.getPixelRatio=function(){return It},this.setPixelRatio=function(v){v!==void 0&&(It=v,this.setSize(ut,Ft,!1))},this.getSize=function(v){return v.set(ut,Ft)},this.setSize=function(v,U,B=!0){if(et.isPresenting){Rt("WebGLRenderer: Can't change size while VR device is presenting.");return}ut=v,Ft=U,e.width=Math.floor(v*It),e.height=Math.floor(U*It),B===!0&&(e.style.width=v+"px",e.style.height=U+"px"),F!==null&&F.setSize(e.width,e.height),this.setViewport(0,0,v,U)},this.getDrawingBufferSize=function(v){return v.set(ut*It,Ft*It).floor()},this.setDrawingBufferSize=function(v,U,B){ut=v,Ft=U,It=B,e.width=Math.floor(v*B),e.height=Math.floor(U*B),this.setViewport(0,0,v,U)},this.setEffects=function(v){if(x===Ne){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(v){for(let U=0;U<v.length;U++)if(v[U].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}F.setEffects(v||[])},this.getCurrentViewport=function(v){return v.copy(k)},this.getViewport=function(v){return v.copy(q)},this.setViewport=function(v,U,B,O){v.isVector4?q.set(v.x,v.y,v.z,v.w):q.set(v,U,B,O),vt.viewport(k.copy(q).multiplyScalar(It).round())},this.getScissor=function(v){return v.copy(K)},this.setScissor=function(v,U,B,O){v.isVector4?K.set(v.x,v.y,v.z,v.w):K.set(v,U,B,O),vt.scissor(z.copy(K).multiplyScalar(It).round())},this.getScissorTest=function(){return pt},this.setScissorTest=function(v){vt.setScissorTest(pt=v)},this.setOpaqueSort=function(v){re=v},this.setTransparentSort=function(v){ne=v},this.getClearColor=function(v){return v.copy(it.getClearColor())},this.setClearColor=function(){it.setClearColor(...arguments)},this.getClearAlpha=function(){return it.getClearAlpha()},this.setClearAlpha=function(){it.setClearAlpha(...arguments)},this.clear=function(v=!0,U=!0,B=!0){let O=0;if(v){let N=!1;if(V!==null){const st=V.texture.format;N=m.has(st)}if(N){const st=V.texture.type,dt=f.has(st),lt=it.getClearColor(),mt=it.getClearAlpha(),Et=lt.r,At=lt.g,Tt=lt.b;dt?(b[0]=Et,b[1]=At,b[2]=Tt,b[3]=mt,C.clearBufferuiv(C.COLOR,0,b)):(M[0]=Et,M[1]=At,M[2]=Tt,M[3]=mt,C.clearBufferiv(C.COLOR,0,M))}else O|=C.COLOR_BUFFER_BIT}U&&(O|=C.DEPTH_BUFFER_BIT),B&&(O|=C.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),C.clear(O)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",Ct,!1),e.removeEventListener("webglcontextrestored",te,!1),e.removeEventListener("webglcontextcreationerror",Yt,!1),it.dispose(),Q.dispose(),rt.dispose(),g.dispose(),W.dispose(),J.dispose(),nt.dispose(),ft.dispose(),j.dispose(),xt.dispose(),et.dispose(),et.removeEventListener("sessionstart",Fa),et.removeEventListener("sessionend",Oa),bn.stop()};function Ct(v){v.preventDefault(),Ka("WebGLRenderer: Context Lost."),E=!0}function te(){Ka("WebGLRenderer: Context Restored."),E=!1;const v=T.autoReset,U=St.enabled,B=St.autoUpdate,O=St.needsUpdate,N=St.type;Z(),T.autoReset=v,St.enabled=U,St.autoUpdate=B,St.needsUpdate=O,St.type=N}function Yt(v){kt("WebGLRenderer: A WebGL context could not be created. Reason: ",v.statusMessage)}function qe(v){const U=v.target;U.removeEventListener("dispose",qe),rn(U)}function rn(v){Xl(v),g.remove(v)}function Xl(v){const U=g.get(v).programs;U!==void 0&&(U.forEach(function(B){xt.releaseProgram(B)}),v.isShaderMaterial&&xt.releaseShaderCache(v))}this.renderBufferDirect=function(v,U,B,O,N,st){U===null&&(U=Kt);const dt=N.isMesh&&N.matrixWorld.determinant()<0,lt=Yl(v,U,B,O,N);vt.setMaterial(O,dt);let mt=B.index,Et=1;if(O.wireframe===!0){if(mt=Mt.getWireframeAttribute(B),mt===void 0)return;Et=2}const At=B.drawRange,Tt=B.attributes.position;let Ot=At.start*Et,$t=(At.start+At.count)*Et;st!==null&&(Ot=Math.max(Ot,st.start*Et),$t=Math.min($t,(st.start+st.count)*Et)),mt!==null?(Ot=Math.max(Ot,0),$t=Math.min($t,mt.count)):Tt!=null&&(Ot=Math.max(Ot,0),$t=Math.min($t,Tt.count));const ae=$t-Ot;if(ae<0||ae===1/0)return;ft.setup(N,O,lt,B,mt);let oe,jt=P;if(mt!==null&&(oe=H.get(mt),jt=ct,jt.setIndex(oe)),N.isMesh)O.wireframe===!0?(vt.setLineWidth(O.wireframeLinewidth*ce()),jt.setMode(C.LINES)):jt.setMode(C.TRIANGLES);else if(N.isLine){let bt=O.linewidth;bt===void 0&&(bt=1),vt.setLineWidth(bt*ce()),N.isLineSegments?jt.setMode(C.LINES):N.isLineLoop?jt.setMode(C.LINE_LOOP):jt.setMode(C.LINE_STRIP)}else N.isPoints?jt.setMode(C.POINTS):N.isSprite&&jt.setMode(C.TRIANGLES);if(N.isBatchedMesh)if(N._multiDrawInstances!==null)Di("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),jt.renderMultiDrawInstances(N._multiDrawStarts,N._multiDrawCounts,N._multiDrawCount,N._multiDrawInstances);else if(Xt.get("WEBGL_multi_draw"))jt.renderMultiDraw(N._multiDrawStarts,N._multiDrawCounts,N._multiDrawCount);else{const bt=N._multiDrawStarts,Zt=N._multiDrawCounts,Ht=N._multiDrawCount,Pe=mt?H.get(mt).bytesPerElement:1,Vn=g.get(O).currentProgram.getUniforms();for(let De=0;De<Ht;De++)Vn.setValue(C,"_gl_DrawID",De),jt.render(bt[De]/Pe,Zt[De])}else if(N.isInstancedMesh)jt.renderInstances(Ot,ae,N.count);else if(B.isInstancedBufferGeometry){const bt=B._maxInstanceCount!==void 0?B._maxInstanceCount:1/0,Zt=Math.min(B.instanceCount,bt);jt.renderInstances(Ot,ae,Zt)}else jt.render(Ot,ae)};function Na(v,U,B){v.transparent===!0&&v.side===He&&v.forceSinglePass===!1?(v.side=Ce,v.needsUpdate=!0,Gi(v,U,B),v.side=Tn,v.needsUpdate=!0,Gi(v,U,B),v.side=He):Gi(v,U,B)}this.compile=function(v,U,B=null){B===null&&(B=v),A=rt.get(B),A.init(U),R.push(A),B.traverseVisible(function(N){N.isLight&&N.layers.test(U.layers)&&(A.pushLight(N),N.castShadow&&A.pushShadow(N))}),v!==B&&v.traverseVisible(function(N){N.isLight&&N.layers.test(U.layers)&&(A.pushLight(N),N.castShadow&&A.pushShadow(N))}),A.setupLights();const O=new Set;return v.traverse(function(N){if(!(N.isMesh||N.isPoints||N.isLine||N.isSprite))return;const st=N.material;if(st)if(Array.isArray(st))for(let dt=0;dt<st.length;dt++){const lt=st[dt];Na(lt,B,N),O.add(lt)}else Na(st,B,N),O.add(st)}),A=R.pop(),O},this.compileAsync=function(v,U,B=null){const O=this.compile(v,U,B);return new Promise(N=>{function st(){if(O.forEach(function(dt){g.get(dt).currentProgram.isReady()&&O.delete(dt)}),O.size===0){N(v);return}setTimeout(st,10)}Xt.get("KHR_parallel_shader_compile")!==null?st():setTimeout(st,10)})};let Nr=null;function ql(v){Nr&&Nr(v)}function Fa(){bn.stop()}function Oa(){bn.start()}const bn=new Vl;bn.setAnimationLoop(ql),typeof self<"u"&&bn.setContext(self),this.setAnimationLoop=function(v){Nr=v,et.setAnimationLoop(v),v===null?bn.stop():bn.start()},et.addEventListener("sessionstart",Fa),et.addEventListener("sessionend",Oa),this.render=function(v,U){if(U!==void 0&&U.isCamera!==!0){kt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(E===!0)return;const B=et.enabled===!0&&et.isPresenting===!0,O=F!==null&&(V===null||B)&&F.begin(S,V);if(v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),et.enabled===!0&&et.isPresenting===!0&&(F===null||F.isCompositing()===!1)&&(et.cameraAutoUpdate===!0&&et.updateCamera(U),U=et.getCamera()),v.isScene===!0&&v.onBeforeRender(S,v,U,V),A=rt.get(v,R.length),A.init(U),R.push(A),me.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),Pt.setFromProjectionMatrix(me,$e,U.reversedDepth),Gt=this.localClippingEnabled,_t=gt.init(this.clippingPlanes,Gt),y=Q.get(v,w.length),y.init(),w.push(y),et.enabled===!0&&et.isPresenting===!0){const dt=S.xr.getDepthSensingMesh();dt!==null&&Fr(dt,U,-1/0,S.sortObjects)}Fr(v,U,0,S.sortObjects),y.finish(),S.sortObjects===!0&&y.sort(re,ne),Ut=et.enabled===!1||et.isPresenting===!1||et.hasDepthSensing()===!1,Ut&&it.addToRenderList(y,v),this.info.render.frame++,_t===!0&&gt.beginShadows();const N=A.state.shadowsArray;if(St.render(N,v,U),_t===!0&&gt.endShadows(),this.info.autoReset===!0&&this.info.reset(),(O&&F.hasRenderPass())===!1){const dt=y.opaque,lt=y.transmissive;if(A.setupLights(),U.isArrayCamera){const mt=U.cameras;if(lt.length>0)for(let Et=0,At=mt.length;Et<At;Et++){const Tt=mt[Et];za(dt,lt,v,Tt)}Ut&&it.render(v);for(let Et=0,At=mt.length;Et<At;Et++){const Tt=mt[Et];Ba(y,v,Tt,Tt.viewport)}}else lt.length>0&&za(dt,lt,v,U),Ut&&it.render(v),Ba(y,v,U)}V!==null&&G===0&&(I.updateMultisampleRenderTarget(V),I.updateRenderTargetMipmap(V)),O&&F.end(S),v.isScene===!0&&v.onAfterRender(S,v,U),ft.resetDefaultState(),Y=-1,X=null,R.pop(),R.length>0?(A=R[R.length-1],_t===!0&&gt.setGlobalState(S.clippingPlanes,A.state.camera)):A=null,w.pop(),w.length>0?y=w[w.length-1]:y=null};function Fr(v,U,B,O){if(v.visible===!1)return;if(v.layers.test(U.layers)){if(v.isGroup)B=v.renderOrder;else if(v.isLOD)v.autoUpdate===!0&&v.update(U);else if(v.isLight)A.pushLight(v),v.castShadow&&A.pushShadow(v);else if(v.isSprite){if(!v.frustumCulled||Pt.intersectsSprite(v)){O&&qt.setFromMatrixPosition(v.matrixWorld).applyMatrix4(me);const dt=nt.update(v),lt=v.material;lt.visible&&y.push(v,dt,lt,B,qt.z,null)}}else if((v.isMesh||v.isLine||v.isPoints)&&(!v.frustumCulled||Pt.intersectsObject(v))){const dt=nt.update(v),lt=v.material;if(O&&(v.boundingSphere!==void 0?(v.boundingSphere===null&&v.computeBoundingSphere(),qt.copy(v.boundingSphere.center)):(dt.boundingSphere===null&&dt.computeBoundingSphere(),qt.copy(dt.boundingSphere.center)),qt.applyMatrix4(v.matrixWorld).applyMatrix4(me)),Array.isArray(lt)){const mt=dt.groups;for(let Et=0,At=mt.length;Et<At;Et++){const Tt=mt[Et],Ot=lt[Tt.materialIndex];Ot&&Ot.visible&&y.push(v,dt,Ot,B,qt.z,Tt)}}else lt.visible&&y.push(v,dt,lt,B,qt.z,null)}}const st=v.children;for(let dt=0,lt=st.length;dt<lt;dt++)Fr(st[dt],U,B,O)}function Ba(v,U,B,O){const{opaque:N,transmissive:st,transparent:dt}=v;A.setupLightsView(B),_t===!0&&gt.setGlobalState(S.clippingPlanes,B),O&&vt.viewport(k.copy(O)),N.length>0&&Vi(N,U,B),st.length>0&&Vi(st,U,B),dt.length>0&&Vi(dt,U,B),vt.buffers.depth.setTest(!0),vt.buffers.depth.setMask(!0),vt.buffers.color.setMask(!0),vt.setPolygonOffset(!1)}function za(v,U,B,O){if((B.isScene===!0?B.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[O.id]===void 0){const Ot=Xt.has("EXT_color_buffer_half_float")||Xt.has("EXT_color_buffer_float");A.state.transmissionRenderTarget[O.id]=new je(1,1,{generateMipmaps:!0,type:Ot?dn:Ne,minFilter:Fn,samples:Qt.samples,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Vt.workingColorSpace})}const st=A.state.transmissionRenderTarget[O.id],dt=O.viewport||k;st.setSize(dt.z*S.transmissionResolutionScale,dt.w*S.transmissionResolutionScale);const lt=S.getRenderTarget(),mt=S.getActiveCubeFace(),Et=S.getActiveMipmapLevel();S.setRenderTarget(st),S.getClearColor(ht),at=S.getClearAlpha(),at<1&&S.setClearColor(16777215,.5),S.clear(),Ut&&it.render(B);const At=S.toneMapping;S.toneMapping=Ke;const Tt=O.viewport;if(O.viewport!==void 0&&(O.viewport=void 0),A.setupLightsView(O),_t===!0&&gt.setGlobalState(S.clippingPlanes,O),Vi(v,B,O),I.updateMultisampleRenderTarget(st),I.updateRenderTargetMipmap(st),Xt.has("WEBGL_multisampled_render_to_texture")===!1){let Ot=!1;for(let $t=0,ae=U.length;$t<ae;$t++){const oe=U[$t],{object:jt,geometry:bt,material:Zt,group:Ht}=oe;if(Zt.side===He&&jt.layers.test(O.layers)){const Pe=Zt.side;Zt.side=Ce,Zt.needsUpdate=!0,Va(jt,B,O,bt,Zt,Ht),Zt.side=Pe,Zt.needsUpdate=!0,Ot=!0}}Ot===!0&&(I.updateMultisampleRenderTarget(st),I.updateRenderTargetMipmap(st))}S.setRenderTarget(lt,mt,Et),S.setClearColor(ht,at),Tt!==void 0&&(O.viewport=Tt),S.toneMapping=At}function Vi(v,U,B){const O=U.isScene===!0?U.overrideMaterial:null;for(let N=0,st=v.length;N<st;N++){const dt=v[N],{object:lt,geometry:mt,group:Et}=dt;let At=dt.material;At.allowOverride===!0&&O!==null&&(At=O),lt.layers.test(B.layers)&&Va(lt,U,B,mt,At,Et)}}function Va(v,U,B,O,N,st){v.onBeforeRender(S,U,B,O,N,st),v.modelViewMatrix.multiplyMatrices(B.matrixWorldInverse,v.matrixWorld),v.normalMatrix.getNormalMatrix(v.modelViewMatrix),N.onBeforeRender(S,U,B,O,v,st),N.transparent===!0&&N.side===He&&N.forceSinglePass===!1?(N.side=Ce,N.needsUpdate=!0,S.renderBufferDirect(B,U,O,N,v,st),N.side=Tn,N.needsUpdate=!0,S.renderBufferDirect(B,U,O,N,v,st),N.side=He):S.renderBufferDirect(B,U,O,N,v,st),v.onAfterRender(S,U,B,O,N,st)}function Gi(v,U,B){U.isScene!==!0&&(U=Kt);const O=g.get(v),N=A.state.lights,st=A.state.shadowsArray,dt=N.state.version,lt=xt.getParameters(v,N.state,st,U,B),mt=xt.getProgramCacheKey(lt);let Et=O.programs;O.environment=v.isMeshStandardMaterial?U.environment:null,O.fog=U.fog,O.envMap=(v.isMeshStandardMaterial?J:W).get(v.envMap||O.environment),O.envMapRotation=O.environment!==null&&v.envMap===null?U.environmentRotation:v.envMapRotation,Et===void 0&&(v.addEventListener("dispose",qe),Et=new Map,O.programs=Et);let At=Et.get(mt);if(At!==void 0){if(O.currentProgram===At&&O.lightsStateVersion===dt)return Ha(v,lt),At}else lt.uniforms=xt.getUniforms(v),v.onBeforeCompile(lt,S),At=xt.acquireProgram(lt,mt),Et.set(mt,At),O.uniforms=lt.uniforms;const Tt=O.uniforms;return(!v.isShaderMaterial&&!v.isRawShaderMaterial||v.clipping===!0)&&(Tt.clippingPlanes=gt.uniform),Ha(v,lt),O.needsLights=Jl(v),O.lightsStateVersion=dt,O.needsLights&&(Tt.ambientLightColor.value=N.state.ambient,Tt.lightProbe.value=N.state.probe,Tt.directionalLights.value=N.state.directional,Tt.directionalLightShadows.value=N.state.directionalShadow,Tt.spotLights.value=N.state.spot,Tt.spotLightShadows.value=N.state.spotShadow,Tt.rectAreaLights.value=N.state.rectArea,Tt.ltc_1.value=N.state.rectAreaLTC1,Tt.ltc_2.value=N.state.rectAreaLTC2,Tt.pointLights.value=N.state.point,Tt.pointLightShadows.value=N.state.pointShadow,Tt.hemisphereLights.value=N.state.hemi,Tt.directionalShadowMap.value=N.state.directionalShadowMap,Tt.directionalShadowMatrix.value=N.state.directionalShadowMatrix,Tt.spotShadowMap.value=N.state.spotShadowMap,Tt.spotLightMatrix.value=N.state.spotLightMatrix,Tt.spotLightMap.value=N.state.spotLightMap,Tt.pointShadowMap.value=N.state.pointShadowMap,Tt.pointShadowMatrix.value=N.state.pointShadowMatrix),O.currentProgram=At,O.uniformsList=null,At}function Ga(v){if(v.uniformsList===null){const U=v.currentProgram.getUniforms();v.uniformsList=Mr.seqWithValue(U.seq,v.uniforms)}return v.uniformsList}function Ha(v,U){const B=g.get(v);B.outputColorSpace=U.outputColorSpace,B.batching=U.batching,B.batchingColor=U.batchingColor,B.instancing=U.instancing,B.instancingColor=U.instancingColor,B.instancingMorph=U.instancingMorph,B.skinning=U.skinning,B.morphTargets=U.morphTargets,B.morphNormals=U.morphNormals,B.morphColors=U.morphColors,B.morphTargetsCount=U.morphTargetsCount,B.numClippingPlanes=U.numClippingPlanes,B.numIntersection=U.numClipIntersection,B.vertexAlphas=U.vertexAlphas,B.vertexTangents=U.vertexTangents,B.toneMapping=U.toneMapping}function Yl(v,U,B,O,N){U.isScene!==!0&&(U=Kt),I.resetTextureUnits();const st=U.fog,dt=O.isMeshStandardMaterial?U.environment:null,lt=V===null?S.outputColorSpace:V.isXRRenderTarget===!0?V.texture.colorSpace:ai,mt=(O.isMeshStandardMaterial?J:W).get(O.envMap||dt),Et=O.vertexColors===!0&&!!B.attributes.color&&B.attributes.color.itemSize===4,At=!!B.attributes.tangent&&(!!O.normalMap||O.anisotropy>0),Tt=!!B.morphAttributes.position,Ot=!!B.morphAttributes.normal,$t=!!B.morphAttributes.color;let ae=Ke;O.toneMapped&&(V===null||V.isXRRenderTarget===!0)&&(ae=S.toneMapping);const oe=B.morphAttributes.position||B.morphAttributes.normal||B.morphAttributes.color,jt=oe!==void 0?oe.length:0,bt=g.get(O),Zt=A.state.lights;if(_t===!0&&(Gt===!0||v!==X)){const Ee=v===X&&O.id===Y;gt.setState(O,v,Ee)}let Ht=!1;O.version===bt.__version?(bt.needsLights&&bt.lightsStateVersion!==Zt.state.version||bt.outputColorSpace!==lt||N.isBatchedMesh&&bt.batching===!1||!N.isBatchedMesh&&bt.batching===!0||N.isBatchedMesh&&bt.batchingColor===!0&&N.colorTexture===null||N.isBatchedMesh&&bt.batchingColor===!1&&N.colorTexture!==null||N.isInstancedMesh&&bt.instancing===!1||!N.isInstancedMesh&&bt.instancing===!0||N.isSkinnedMesh&&bt.skinning===!1||!N.isSkinnedMesh&&bt.skinning===!0||N.isInstancedMesh&&bt.instancingColor===!0&&N.instanceColor===null||N.isInstancedMesh&&bt.instancingColor===!1&&N.instanceColor!==null||N.isInstancedMesh&&bt.instancingMorph===!0&&N.morphTexture===null||N.isInstancedMesh&&bt.instancingMorph===!1&&N.morphTexture!==null||bt.envMap!==mt||O.fog===!0&&bt.fog!==st||bt.numClippingPlanes!==void 0&&(bt.numClippingPlanes!==gt.numPlanes||bt.numIntersection!==gt.numIntersection)||bt.vertexAlphas!==Et||bt.vertexTangents!==At||bt.morphTargets!==Tt||bt.morphNormals!==Ot||bt.morphColors!==$t||bt.toneMapping!==ae||bt.morphTargetsCount!==jt)&&(Ht=!0):(Ht=!0,bt.__version=O.version);let Pe=bt.currentProgram;Ht===!0&&(Pe=Gi(O,U,N));let Vn=!1,De=!1,di=!1;const ee=Pe.getUniforms(),Ae=bt.uniforms;if(vt.useProgram(Pe.program)&&(Vn=!0,De=!0,di=!0),O.id!==Y&&(Y=O.id,De=!0),Vn||X!==v){vt.buffers.depth.getReversed()&&v.reversedDepth!==!0&&(v._reversedDepth=!0,v.updateProjectionMatrix()),ee.setValue(C,"projectionMatrix",v.projectionMatrix),ee.setValue(C,"viewMatrix",v.matrixWorldInverse);const we=ee.map.cameraPosition;we!==void 0&&we.setValue(C,zt.setFromMatrixPosition(v.matrixWorld)),Qt.logarithmicDepthBuffer&&ee.setValue(C,"logDepthBufFC",2/(Math.log(v.far+1)/Math.LN2)),(O.isMeshPhongMaterial||O.isMeshToonMaterial||O.isMeshLambertMaterial||O.isMeshBasicMaterial||O.isMeshStandardMaterial||O.isShaderMaterial)&&ee.setValue(C,"isOrthographic",v.isOrthographicCamera===!0),X!==v&&(X=v,De=!0,di=!0)}if(bt.needsLights&&(Zt.state.directionalShadowMap.length>0&&ee.setValue(C,"directionalShadowMap",Zt.state.directionalShadowMap,I),Zt.state.spotShadowMap.length>0&&ee.setValue(C,"spotShadowMap",Zt.state.spotShadowMap,I),Zt.state.pointShadowMap.length>0&&ee.setValue(C,"pointShadowMap",Zt.state.pointShadowMap,I)),N.isSkinnedMesh){ee.setOptional(C,N,"bindMatrix"),ee.setOptional(C,N,"bindMatrixInverse");const Ee=N.skeleton;Ee&&(Ee.boneTexture===null&&Ee.computeBoneTexture(),ee.setValue(C,"boneTexture",Ee.boneTexture,I))}N.isBatchedMesh&&(ee.setOptional(C,N,"batchingTexture"),ee.setValue(C,"batchingTexture",N._matricesTexture,I),ee.setOptional(C,N,"batchingIdTexture"),ee.setValue(C,"batchingIdTexture",N._indirectTexture,I),ee.setOptional(C,N,"batchingColorTexture"),N._colorsTexture!==null&&ee.setValue(C,"batchingColorTexture",N._colorsTexture,I));const Fe=B.morphAttributes;if((Fe.position!==void 0||Fe.normal!==void 0||Fe.color!==void 0)&&Nt.update(N,B,Pe),(De||bt.receiveShadow!==N.receiveShadow)&&(bt.receiveShadow=N.receiveShadow,ee.setValue(C,"receiveShadow",N.receiveShadow)),O.isMeshGouraudMaterial&&O.envMap!==null&&(Ae.envMap.value=mt,Ae.flipEnvMap.value=mt.isCubeTexture&&mt.isRenderTargetTexture===!1?-1:1),O.isMeshStandardMaterial&&O.envMap===null&&U.environment!==null&&(Ae.envMapIntensity.value=U.environmentIntensity),Ae.dfgLUT!==void 0&&(Ae.dfgLUT.value=Ym()),De&&(ee.setValue(C,"toneMappingExposure",S.toneMappingExposure),bt.needsLights&&Zl(Ae,di),st&&O.fog===!0&&wt.refreshFogUniforms(Ae,st),wt.refreshMaterialUniforms(Ae,O,It,Ft,A.state.transmissionRenderTarget[v.id]),Mr.upload(C,Ga(bt),Ae,I)),O.isShaderMaterial&&O.uniformsNeedUpdate===!0&&(Mr.upload(C,Ga(bt),Ae,I),O.uniformsNeedUpdate=!1),O.isSpriteMaterial&&ee.setValue(C,"center",N.center),ee.setValue(C,"modelViewMatrix",N.modelViewMatrix),ee.setValue(C,"normalMatrix",N.normalMatrix),ee.setValue(C,"modelMatrix",N.matrixWorld),O.isShaderMaterial||O.isRawShaderMaterial){const Ee=O.uniformsGroups;for(let we=0,Or=Ee.length;we<Or;we++){const An=Ee[we];j.update(An,Pe),j.bind(An,Pe)}}return Pe}function Zl(v,U){v.ambientLightColor.needsUpdate=U,v.lightProbe.needsUpdate=U,v.directionalLights.needsUpdate=U,v.directionalLightShadows.needsUpdate=U,v.pointLights.needsUpdate=U,v.pointLightShadows.needsUpdate=U,v.spotLights.needsUpdate=U,v.spotLightShadows.needsUpdate=U,v.rectAreaLights.needsUpdate=U,v.hemisphereLights.needsUpdate=U}function Jl(v){return v.isMeshLambertMaterial||v.isMeshToonMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isShadowMaterial||v.isShaderMaterial&&v.lights===!0}this.getActiveCubeFace=function(){return L},this.getActiveMipmapLevel=function(){return G},this.getRenderTarget=function(){return V},this.setRenderTargetTextures=function(v,U,B){const O=g.get(v);O.__autoAllocateDepthBuffer=v.resolveDepthBuffer===!1,O.__autoAllocateDepthBuffer===!1&&(O.__useRenderToTexture=!1),g.get(v.texture).__webglTexture=U,g.get(v.depthTexture).__webglTexture=O.__autoAllocateDepthBuffer?void 0:B,O.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(v,U){const B=g.get(v);B.__webglFramebuffer=U,B.__useDefaultFramebuffer=U===void 0};const $l=C.createFramebuffer();this.setRenderTarget=function(v,U=0,B=0){V=v,L=U,G=B;let O=null,N=!1,st=!1;if(v){const lt=g.get(v);if(lt.__useDefaultFramebuffer!==void 0){vt.bindFramebuffer(C.FRAMEBUFFER,lt.__webglFramebuffer),k.copy(v.viewport),z.copy(v.scissor),$=v.scissorTest,vt.viewport(k),vt.scissor(z),vt.setScissorTest($),Y=-1;return}else if(lt.__webglFramebuffer===void 0)I.setupRenderTarget(v);else if(lt.__hasExternalTextures)I.rebindTextures(v,g.get(v.texture).__webglTexture,g.get(v.depthTexture).__webglTexture);else if(v.depthBuffer){const At=v.depthTexture;if(lt.__boundDepthTexture!==At){if(At!==null&&g.has(At)&&(v.width!==At.image.width||v.height!==At.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");I.setupDepthRenderbuffer(v)}}const mt=v.texture;(mt.isData3DTexture||mt.isDataArrayTexture||mt.isCompressedArrayTexture)&&(st=!0);const Et=g.get(v).__webglFramebuffer;v.isWebGLCubeRenderTarget?(Array.isArray(Et[U])?O=Et[U][B]:O=Et[U],N=!0):v.samples>0&&I.useMultisampledRTT(v)===!1?O=g.get(v).__webglMultisampledFramebuffer:Array.isArray(Et)?O=Et[B]:O=Et,k.copy(v.viewport),z.copy(v.scissor),$=v.scissorTest}else k.copy(q).multiplyScalar(It).floor(),z.copy(K).multiplyScalar(It).floor(),$=pt;if(B!==0&&(O=$l),vt.bindFramebuffer(C.FRAMEBUFFER,O)&&vt.drawBuffers(v,O),vt.viewport(k),vt.scissor(z),vt.setScissorTest($),N){const lt=g.get(v.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_CUBE_MAP_POSITIVE_X+U,lt.__webglTexture,B)}else if(st){const lt=U;for(let mt=0;mt<v.textures.length;mt++){const Et=g.get(v.textures[mt]);C.framebufferTextureLayer(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0+mt,Et.__webglTexture,B,lt)}}else if(v!==null&&B!==0){const lt=g.get(v.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,lt.__webglTexture,B)}Y=-1},this.readRenderTargetPixels=function(v,U,B,O,N,st,dt,lt=0){if(!(v&&v.isWebGLRenderTarget)){kt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let mt=g.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&dt!==void 0&&(mt=mt[dt]),mt){vt.bindFramebuffer(C.FRAMEBUFFER,mt);try{const Et=v.textures[lt],At=Et.format,Tt=Et.type;if(!Qt.textureFormatReadable(At)){kt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Qt.textureTypeReadable(Tt)){kt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=v.width-O&&B>=0&&B<=v.height-N&&(v.textures.length>1&&C.readBuffer(C.COLOR_ATTACHMENT0+lt),C.readPixels(U,B,O,N,tt.convert(At),tt.convert(Tt),st))}finally{const Et=V!==null?g.get(V).__webglFramebuffer:null;vt.bindFramebuffer(C.FRAMEBUFFER,Et)}}},this.readRenderTargetPixelsAsync=async function(v,U,B,O,N,st,dt,lt=0){if(!(v&&v.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let mt=g.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&dt!==void 0&&(mt=mt[dt]),mt)if(U>=0&&U<=v.width-O&&B>=0&&B<=v.height-N){vt.bindFramebuffer(C.FRAMEBUFFER,mt);const Et=v.textures[lt],At=Et.format,Tt=Et.type;if(!Qt.textureFormatReadable(At))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Qt.textureTypeReadable(Tt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Ot=C.createBuffer();C.bindBuffer(C.PIXEL_PACK_BUFFER,Ot),C.bufferData(C.PIXEL_PACK_BUFFER,st.byteLength,C.STREAM_READ),v.textures.length>1&&C.readBuffer(C.COLOR_ATTACHMENT0+lt),C.readPixels(U,B,O,N,tt.convert(At),tt.convert(Tt),0);const $t=V!==null?g.get(V).__webglFramebuffer:null;vt.bindFramebuffer(C.FRAMEBUFFER,$t);const ae=C.fenceSync(C.SYNC_GPU_COMMANDS_COMPLETE,0);return C.flush(),await Fc(C,ae,4),C.bindBuffer(C.PIXEL_PACK_BUFFER,Ot),C.getBufferSubData(C.PIXEL_PACK_BUFFER,0,st),C.deleteBuffer(Ot),C.deleteSync(ae),st}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(v,U=null,B=0){const O=Math.pow(2,-B),N=Math.floor(v.image.width*O),st=Math.floor(v.image.height*O),dt=U!==null?U.x:0,lt=U!==null?U.y:0;I.setTexture2D(v,0),C.copyTexSubImage2D(C.TEXTURE_2D,B,0,0,dt,lt,N,st),vt.unbindTexture()};const Kl=C.createFramebuffer(),jl=C.createFramebuffer();this.copyTextureToTexture=function(v,U,B=null,O=null,N=0,st=null){st===null&&(N!==0?(Di("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),st=N,N=0):st=0);let dt,lt,mt,Et,At,Tt,Ot,$t,ae;const oe=v.isCompressedTexture?v.mipmaps[st]:v.image;if(B!==null)dt=B.max.x-B.min.x,lt=B.max.y-B.min.y,mt=B.isBox3?B.max.z-B.min.z:1,Et=B.min.x,At=B.min.y,Tt=B.isBox3?B.min.z:0;else{const Fe=Math.pow(2,-N);dt=Math.floor(oe.width*Fe),lt=Math.floor(oe.height*Fe),v.isDataArrayTexture?mt=oe.depth:v.isData3DTexture?mt=Math.floor(oe.depth*Fe):mt=1,Et=0,At=0,Tt=0}O!==null?(Ot=O.x,$t=O.y,ae=O.z):(Ot=0,$t=0,ae=0);const jt=tt.convert(U.format),bt=tt.convert(U.type);let Zt;U.isData3DTexture?(I.setTexture3D(U,0),Zt=C.TEXTURE_3D):U.isDataArrayTexture||U.isCompressedArrayTexture?(I.setTexture2DArray(U,0),Zt=C.TEXTURE_2D_ARRAY):(I.setTexture2D(U,0),Zt=C.TEXTURE_2D),C.pixelStorei(C.UNPACK_FLIP_Y_WEBGL,U.flipY),C.pixelStorei(C.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),C.pixelStorei(C.UNPACK_ALIGNMENT,U.unpackAlignment);const Ht=C.getParameter(C.UNPACK_ROW_LENGTH),Pe=C.getParameter(C.UNPACK_IMAGE_HEIGHT),Vn=C.getParameter(C.UNPACK_SKIP_PIXELS),De=C.getParameter(C.UNPACK_SKIP_ROWS),di=C.getParameter(C.UNPACK_SKIP_IMAGES);C.pixelStorei(C.UNPACK_ROW_LENGTH,oe.width),C.pixelStorei(C.UNPACK_IMAGE_HEIGHT,oe.height),C.pixelStorei(C.UNPACK_SKIP_PIXELS,Et),C.pixelStorei(C.UNPACK_SKIP_ROWS,At),C.pixelStorei(C.UNPACK_SKIP_IMAGES,Tt);const ee=v.isDataArrayTexture||v.isData3DTexture,Ae=U.isDataArrayTexture||U.isData3DTexture;if(v.isDepthTexture){const Fe=g.get(v),Ee=g.get(U),we=g.get(Fe.__renderTarget),Or=g.get(Ee.__renderTarget);vt.bindFramebuffer(C.READ_FRAMEBUFFER,we.__webglFramebuffer),vt.bindFramebuffer(C.DRAW_FRAMEBUFFER,Or.__webglFramebuffer);for(let An=0;An<mt;An++)ee&&(C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,g.get(v).__webglTexture,N,Tt+An),C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,g.get(U).__webglTexture,st,ae+An)),C.blitFramebuffer(Et,At,dt,lt,Ot,$t,dt,lt,C.DEPTH_BUFFER_BIT,C.NEAREST);vt.bindFramebuffer(C.READ_FRAMEBUFFER,null),vt.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else if(N!==0||v.isRenderTargetTexture||g.has(v)){const Fe=g.get(v),Ee=g.get(U);vt.bindFramebuffer(C.READ_FRAMEBUFFER,Kl),vt.bindFramebuffer(C.DRAW_FRAMEBUFFER,jl);for(let we=0;we<mt;we++)ee?C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,Fe.__webglTexture,N,Tt+we):C.framebufferTexture2D(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,Fe.__webglTexture,N),Ae?C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,Ee.__webglTexture,st,ae+we):C.framebufferTexture2D(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,Ee.__webglTexture,st),N!==0?C.blitFramebuffer(Et,At,dt,lt,Ot,$t,dt,lt,C.COLOR_BUFFER_BIT,C.NEAREST):Ae?C.copyTexSubImage3D(Zt,st,Ot,$t,ae+we,Et,At,dt,lt):C.copyTexSubImage2D(Zt,st,Ot,$t,Et,At,dt,lt);vt.bindFramebuffer(C.READ_FRAMEBUFFER,null),vt.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else Ae?v.isDataTexture||v.isData3DTexture?C.texSubImage3D(Zt,st,Ot,$t,ae,dt,lt,mt,jt,bt,oe.data):U.isCompressedArrayTexture?C.compressedTexSubImage3D(Zt,st,Ot,$t,ae,dt,lt,mt,jt,oe.data):C.texSubImage3D(Zt,st,Ot,$t,ae,dt,lt,mt,jt,bt,oe):v.isDataTexture?C.texSubImage2D(C.TEXTURE_2D,st,Ot,$t,dt,lt,jt,bt,oe.data):v.isCompressedTexture?C.compressedTexSubImage2D(C.TEXTURE_2D,st,Ot,$t,oe.width,oe.height,jt,oe.data):C.texSubImage2D(C.TEXTURE_2D,st,Ot,$t,dt,lt,jt,bt,oe);C.pixelStorei(C.UNPACK_ROW_LENGTH,Ht),C.pixelStorei(C.UNPACK_IMAGE_HEIGHT,Pe),C.pixelStorei(C.UNPACK_SKIP_PIXELS,Vn),C.pixelStorei(C.UNPACK_SKIP_ROWS,De),C.pixelStorei(C.UNPACK_SKIP_IMAGES,di),st===0&&U.generateMipmaps&&C.generateMipmap(Zt),vt.unbindTexture()},this.initRenderTarget=function(v){g.get(v).__webglFramebuffer===void 0&&I.setupRenderTarget(v)},this.initTexture=function(v){v.isCubeTexture?I.setTextureCube(v,0):v.isData3DTexture?I.setTexture3D(v,0):v.isDataArrayTexture||v.isCompressedArrayTexture?I.setTexture2DArray(v,0):I.setTexture2D(v,0),vt.unbindTexture()},this.resetState=function(){L=0,G=0,V=null,vt.reset(),ft.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return $e}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=Vt._getDrawingBufferColorSpace(t),e.unpackColorSpace=Vt._getUnpackColorSpace()}}class Jm{constructor(t,e=null){this.canvas=t,this.trailPoints=e,this.scene=new oh,this.camera=new Ue(75,t.width/t.height,.1,1e3),this.renderer=new Zm({canvas:t,alpha:!0,antialias:!0}),this.renderer.setSize(t.width,t.height),this.renderer.setPixelRatio(window.devicePixelRatio),this.heartGroup=new Ei,this.particles=null,this.currentScale=1,this.targetScale=1,this.currentRotationX=0,this.currentRotationY=0,this.targetRotationX=0,this.targetRotationY=0,this.heartColor=16742520,this.heartColorRGB={r:255,g:120,b:120},this.init()}init(){this.camera.position.z=50,this.trailPoints&&this.trailPoints.length>0?this.createHeartFromTrail():this.createHeartGeometry(),this.createParticleSystem();const t=new $h(4210752,2);this.scene.add(t);const e=new Jh(this.heartColor,2,100);e.position.set(0,0,20),this.scene.add(e),this.scene.add(this.heartGroup)}createHeartFromTrail(){const t=this.trailPoints.map(o=>{const l=(.5-o.x)*80,c=(.5-o.y)*80;return new D(l,c,0)});if(t.length<10){this.createHeartGeometry();return}const e=new ma(t,!0),n=new Pr(e,Math.min(t.length*2,100),.8,8,!0),r=new Ro(n),s=new fa({color:this.heartColor,transparent:!0,opacity:.8,linewidth:2}),a=new vo(r,s);this.heartGroup.add(a),this.createFillFromPoints(t),this.createDotMatrix(t)}createFillFromPoints(t){let e=0,n=0;t.forEach(p=>{e+=p.x,n+=p.y}),e/=t.length,n/=t.length;const r=new Sr;let s=1/0,a=-1/0,o=1/0,l=-1/0;t.forEach(p=>{s=Math.min(s,p.x),a=Math.max(a,p.x),o=Math.min(o,p.y),l=Math.max(l,p.y)});const c=this.simplifyPoints(t,20);if(c.length>2){r.moveTo(c[0].x,c[0].y);for(let p=1;p<c.length;p++)r.lineTo(c[p].x,c[p].y);r.closePath()}const h=new Cr(r),u=new Ar({color:this.heartColor,transparent:!0,opacity:.15,side:He}),d=new Xe(h,u);this.heartGroup.add(d)}simplifyPoints(t,e){if(t.length<=e)return t;const n=[],r=t.length/e;for(let s=0;s<e;s++){const a=Math.floor(s*r);n.push(t[a])}return n}createHeartGeometry(){new Sr;const t=[];for(let u=0;u<=Math.PI*2;u+=.1){const d=16*Math.pow(Math.sin(u),3),p=-(13*Math.cos(u)-5*Math.cos(2*u)-2*Math.cos(3*u)-Math.cos(4*u));t.push(new D(d,p,0))}const e=new ma(t,!0),n=new Pr(e,64,.5,8,!0),r=new Ro(n),s=new fa({color:this.heartColor,transparent:!0,opacity:.8,linewidth:2}),a=new vo(r,s);this.heartGroup.add(a);const o=new Ar({color:this.heartColor,transparent:!0,opacity:.15,side:He}),l=new Sr;for(let u=0;u<=Math.PI*2;u+=.1){const d=16*Math.pow(Math.sin(u),3),p=-(13*Math.cos(u)-5*Math.cos(2*u)-2*Math.cos(3*u)-Math.cos(4*u));u===0?l.moveTo(d,p):l.lineTo(d,p)}const c=new Cr(l),h=new Xe(c,o);this.heartGroup.add(h),this.createDotMatrix(t)}createDotMatrix(t){const e=new ye,n=[];t.forEach(a=>{n.push(a.x,a.y,a.z)});for(let a=0;a<50;a++){const o=Math.random()*Math.PI*2,l=Math.random()*.8,c=16*Math.pow(Math.sin(o),3)*l,h=-(13*Math.cos(o)-5*Math.cos(2*o)-2*Math.cos(3*o)-Math.cos(4*o))*l;n.push(c,h,0)}e.setAttribute("position",new fe(n,3));const r=new da({color:this.heartColor,size:.8,transparent:!0,opacity:.9,blending:yr}),s=new Mo(e,r);this.heartGroup.add(s)}createParticleSystem(){const e=new ye,n=[],r=[];for(let a=0;a<300;a++){const o=Math.random()*Math.PI*2,l=Math.random()*Math.PI,c=25+Math.random()*30,h=c*Math.sin(l)*Math.cos(o),u=c*Math.sin(l)*Math.sin(o),d=c*Math.cos(l);n.push(h,u,d),r.push((Math.random()-.5)*.02,(Math.random()-.5)*.02,(Math.random()-.5)*.02)}e.setAttribute("position",new fe(n,3));const s=new da({color:this.heartColor,size:.5,transparent:!0,opacity:.6,blending:yr});this.particles=new Mo(e,s),this.particles.userData={velocities:r},this.scene.add(this.particles)}setScale(t){this.targetScale=Math.max(.5,Math.min(3,t))}setRotation(t,e){this.targetRotationX=t,this.targetRotationY=e}update(){if(this.currentScale+=(this.targetScale-this.currentScale)*.1,this.heartGroup.scale.set(this.currentScale,this.currentScale,this.currentScale),this.currentRotationX+=(this.targetRotationX-this.currentRotationX)*.1,this.currentRotationY+=(this.targetRotationY-this.currentRotationY)*.1,this.heartGroup.rotation.x=this.currentRotationX,this.heartGroup.rotation.y=this.currentRotationY,this.particles){const t=this.particles.geometry.attributes.position.array,e=this.particles.userData.velocities;for(let n=0;n<t.length;n+=3)t[n]+=e[n],t[n+1]+=e[n+1],t[n+2]+=e[n+2],Math.abs(t[n])>60&&(e[n]*=-1),Math.abs(t[n+1])>60&&(e[n+1]*=-1),Math.abs(t[n+2])>60&&(e[n+2]*=-1);this.particles.geometry.attributes.position.needsUpdate=!0,this.particles.rotation.y+=.002}}render(){this.update(),this.renderer.render(this.scene,this.camera)}show(){this.canvas.style.display="block"}hide(){this.canvas.style.display="none"}}class $m{constructor(t,e){this.onScaleChange=t,this.onRotationChange=e,this.currentScale=1,this.targetScale=1,this.baseDistance=null,this.isPinching=!1,this.lastPinchTime=0,this.lastFingerCenter=null,this.currentRotationX=0,this.currentRotationY=0,this.targetRotationX=0,this.targetRotationY=0}processHands(t){if(!t||t.length===0){this.resetPinch();return}const e=t[0],n=e[4],r=e[8];n&&r&&(this.detectPinchGesture(n,r),this.detectRotationGesture(n,r))}detectPinchGesture(t,e){const n=Math.sqrt(Math.pow(t.x-e.x,2)+Math.pow(t.y-e.y,2)),r=Date.now();if(!this.isPinching){this.baseDistance=n,this.isPinching=!0,this.lastPinchTime=r;return}if(!(r-this.lastPinchTime<100)&&(this.lastPinchTime=r,this.baseDistance&&this.baseDistance>0)){const s=n/this.baseDistance,a=this.currentScale*s;this.targetScale=Math.max(.5,Math.min(3,a)),this.onScaleChange&&this.onScaleChange(this.targetScale),this.baseDistance=n*.7+this.baseDistance*.3}}detectRotationGesture(t,e){const n=(t.x+e.x)/2,r=(t.y+e.y)/2;if(!this.lastFingerCenter){this.lastFingerCenter={x:n,y:r};return}const s=n-this.lastFingerCenter.x,a=r-this.lastFingerCenter.y;(Math.abs(s)>.005||Math.abs(a)>.005)&&(this.targetRotationY+=s*3,this.targetRotationX-=a*3,this.targetRotationX=Math.max(-Math.PI/2,Math.min(Math.PI/2,this.targetRotationX)),this.onRotationChange&&this.onRotationChange(this.targetRotationX,this.targetRotationY),this.lastFingerCenter={x:n,y:r})}resetPinch(){this.isPinching=!1,this.baseDistance=null,this.lastFingerCenter=null}setCurrentScale(t){this.currentScale=Math.max(.5,Math.min(3,t)),this.targetScale=this.currentScale}getCurrentScale(){return this.targetScale}getCurrentRotation(){return{x:this.targetRotationX,y:this.targetRotationY}}}class Km{constructor(t){this.canvas=t,this.ctx=t.getContext("2d"),this.width=t.width,this.height=t.height,this.scanLineY=0}drawSimpleBorder(){const t=this.ctx,e=10;t.strokeStyle="rgba(255, 120, 120, 0.3)",t.lineWidth=1,t.strokeRect(e,e,this.width-e*2,this.height-e*2)}drawStatusInfo(t=1){const e=this.ctx;e.font="12px monospace",e.fillStyle="rgba(255, 120, 120, 0.6)",e.fillText(`SCALE: ${t.toFixed(2)}x`,20,35)}render(t=1){this.drawSimpleBorder(),this.drawStatusInfo(t)}}class jm{constructor(){ka(this,"handleCanvasClick",()=>{this.reset()});this.videoElement=document.getElementById("video"),this.canvasElement=document.getElementById("canvas"),this.loadingElement=document.getElementById("loading"),this.loadingText=document.getElementById("loading-text"),this.statusText=document.getElementById("status-text"),this.setupCanvases(),this.heart3D=null,this.gestureController=null,this.techEffects=null,this.handTracker=null,this.isDrawing=!0,this.trail=[],this.lastPoint=null,this.hasDetectedHeart=!1,this.init()}setupCanvases(){this.canvas3D=document.createElement("canvas"),this.canvas3D.id="canvas-3d",this.canvas3D.width=640,this.canvas3D.height=480,this.canvas3D.style.position="absolute",this.canvas3D.style.top="0",this.canvas3D.style.left="0",this.canvas3D.style.zIndex="3",this.canvas3D.style.display="none",this.canvas2D=document.createElement("canvas"),this.canvas2D.id="canvas-2d",this.canvas2D.width=640,this.canvas2D.height=480,this.canvas2D.style.position="absolute",this.canvas2D.style.top="0",this.canvas2D.style.left="0",this.canvas2D.style.zIndex="2";const t=document.querySelector(".canvas-container");t.appendChild(this.canvas3D),t.appendChild(this.canvas2D),this.canvasElement.style.zIndex="1"}async init(){try{this.updateLoadingText("正在加载模型..."),this.gestureController=new $m(e=>{this.heart3D&&this.heart3D.setScale(e)},(e,n)=>{this.heart3D&&this.heart3D.setRotation(e,n)}),this.techEffects=new Km(this.canvas2D),this.handTracker=new ec(this.videoElement,e=>{this.onHandResults(e)}),await this.handTracker.initialize()?(this.updateLoadingText("正在启动摄像头..."),await this.handTracker.start(),this.loadingElement.classList.add("hidden"),this.updateStatus("请举起食指画出爱心"),this.startRenderLoop(),this.startHeartDetection()):(this.updateLoadingText("启动失败"),this.updateStatus("启动失败"))}catch(t){console.error("错误:",t),this.updateLoadingText("无法访问摄像头"),this.updateStatus("无法访问摄像头")}}onHandResults(t){const{indexFingerTip:e,multiHandLandmarks:n}=t;this.isDrawing&&!this.hasDetectedHeart?e?(!this.lastPoint||Math.abs(e.x-this.lastPoint.x)>.002||Math.abs(e.y-this.lastPoint.y)>.002)&&(this.trail.push(e),this.lastPoint=e,this.trail.length>100&&this.trail.shift()):this.lastPoint=null:this.hasDetectedHeart&&n&&n.length>0&&this.gestureController.processHands(n)}detectHeart(){if(this.trail.length<30||this.hasDetectedHeart)return!1;const t=this.analyzeTrajectory();return this.checkHeartFeatures(t)}analyzeTrajectory(){const t=this.trail,e=t.length;let n=0,r=0;t.forEach(M=>{n+=M.x,r+=M.y}),n/=e,r/=e;let s=1,a=0,o=1,l=0;t.forEach(M=>{s=Math.min(s,M.x),a=Math.max(a,M.x),o=Math.min(o,M.y),l=Math.max(l,M.y)});let c=0,h=null;for(let M=2;M<t.length;M++){const y=t[M].x-t[M-2].x,A=t[M].y-t[M-2].y,w=Math.atan2(A,y);h!==null&&Math.abs(w-h)>.3&&c++,h=w}let u=!1,d=!1;const p=t.filter(M=>M.y<r);if(p.length>=8){const M=p.filter(A=>A.x<n-.05),y=p.filter(A=>A.x>n+.05);u=M.length>=3,d=y.length>=3}let _=!1;const x=t.filter(M=>M.y>r);if(x.length>=5){const M=Math.max(...x.map(A=>A.x))-Math.min(...x.map(A=>A.x)),y=a-s;_=M<y*.8}const m=t[0],f=t[t.length-1],b=Math.sqrt(Math.pow(f.x-m.x,2)+Math.pow(f.y-m.y,2));return{centerX:n,centerY:r,width:a-s,height:l-o,directionChanges:c,closureDistance:b,aspectRatio:(a-s)/(l-o+.001),leftBump:u,rightBump:d,hasBottomPoint:_,hasTwoBumps:u&&d}}checkHeartFeatures(t){const e=t.aspectRatio>.5&&t.aspectRatio<2,n=t.directionChanges>=2,r=t.closureDistance<.25,s=t.width>.1&&t.height>.12,a=t.hasTwoBumps&&t.hasBottomPoint;return e&&n&&r&&s&&a}startHeartDetection(){setInterval(()=>{!this.hasDetectedHeart&&this.trail.length>30&&this.detectHeart()&&this.onHeartDetected()},300)}async onHeartDetected(){this.hasDetectedHeart=!0,this.isDrawing=!1,this.updateStatus("检测到爱心！生成3D全息投影..."),this.canvasElement.style.display="none",this.canvas3D.style.display="block",this.heart3D=new Jm(this.canvas3D,this.trail);const t=this.gestureController.getCurrentScale();this.heart3D.setScale(t),this.updateStatus("伸出拇指和食指捏合来缩放爱心"),setTimeout(()=>{this.canvas3D.style.cursor="pointer",this.canvas3D.addEventListener("click",this.handleCanvasClick,{once:!0})},2e3)}reset(){this.hasDetectedHeart=!1,this.isDrawing=!0,this.trail=[],this.lastPoint=null,this.gestureController.setCurrentScale(1),this.canvas3D.style.display="none",this.canvasElement.style.display="block",this.canvas3D.style.cursor="default",this.heart3D&&(this.heart3D.hide(),this.heart3D=null),this.updateStatus("请举起食指画出爱心")}startRenderLoop(){const t=()=>{this.isDrawing?this.drawTrail():this.hasDetectedHeart&&this.heart3D&&(this.heart3D.render(),this.canvas2D.getContext("2d").clearRect(0,0,this.canvas2D.width,this.canvas2D.height),this.techEffects.render(this.gestureController.getCurrentScale())),requestAnimationFrame(t)};t()}drawTrail(){const t=this.canvasElement.getContext("2d");if(t.clearRect(0,0,this.canvasElement.width,this.canvasElement.height),this.trail.length<2)return;t.save(),t.lineCap="round",t.lineJoin="round",t.strokeStyle="rgba(255, 120, 120, 0.95)",t.lineWidth=5,t.shadowBlur=12,t.shadowColor="rgba(255, 120, 120, 0.5)",t.beginPath();const e=this.trail[0];t.moveTo((1-e.x)*this.canvasElement.width,e.y*this.canvasElement.height);for(let r=1;r<this.trail.length;r++){const s=this.trail[r];t.lineTo((1-s.x)*this.canvasElement.width,s.y*this.canvasElement.height)}t.stroke(),t.restore();const n=this.trail[this.trail.length-1];if(n){const r=(1-n.x)*this.canvasElement.width,s=n.y*this.canvasElement.height;t.save(),t.beginPath(),t.arc(r,s,8,0,Math.PI*2),t.fillStyle="rgba(255, 120, 120, 0.95)",t.shadowBlur=16,t.shadowColor="#ff7878",t.fill(),t.restore()}}updateLoadingText(t){this.loadingText.textContent=t}updateStatus(t){this.statusText.textContent=t}}document.addEventListener("DOMContentLoaded",()=>{new jm});
//# sourceMappingURL=index-CYH-89ck.js.map
